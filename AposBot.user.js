        ...
        if (player.length > 0) {
            ...
            for(var i = 0; /*i < player.length*/ i < 1; i++){
                ...
                for(var j = 0; j < allIsIn.length; j++){
                    ...
                    var distance = offsetX * offsetX + offsetY * offsetY + 0.001;
                    if(allIsIn[j].f){
                        cost[direct]-= 10000 / distance;
                    }
                    else if(cellSize * 1.33 < player[i].size)cost[direct]+= cellSize * 10000 / distance;
                    else if(cellSize > 1.33 * player[i].size)cost[direct]-= 10000 / distance;
                }
                var bestDirect = 0;
                var worstDirect = 0;
                for(var i = 1; i < 8 ; i++){
